...
{
    //Make instance of this script to be able to refrence from other scripts!
    public static ScreenFade instance;

    [Header("Initialization")]
    //Game objects used by this code
    public GameObject fadeSceenObject;
    ...
    void Update()
    {
        ...
        if (fadeToBlack)
        {
            fadeScreenImage.color = new Color(fadeScreenImage.color.r, fadeScreenImage.color.g, fadeScreenImage.color.b, Mathf.MoveTowards (fadeScreenImage.color.a,
